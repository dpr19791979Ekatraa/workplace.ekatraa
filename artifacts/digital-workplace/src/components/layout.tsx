...
export default function Layout({ children, title }: LayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      >
        {/* Logo */}
        <div className="flex gap-2.5 px-4 py-5 border-b border-sidebar-border text-[#000000] justify-center items-center border-t-[#332924] border-r-[#332924] border-b-[#332924] border-l-[#332924]">
          <img src="/logo.png" className="h-16 w-auto logo-glow" alt="ekatraa" />
          <Button
            variant="ghost"
            size="icon"
        ...
        {/* User */}
        <div className="p-3 border-t border-sidebar-border border-t-[#332924] border-r-[#332924] border-b-[#332924] border-l-[#332924]">
          <DropdownMenu>
